...
//        thumbnailImage.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 34).isActive = true
//        thumbnailImage.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -34).isActive = true
